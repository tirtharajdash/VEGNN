...
num_lines = sum(1 for line in open('./data/DS/train_split'))
num_trn_lines = round(0.90*num_lines)
train_ids = np.loadtxt('./data/DS/train_split', max_rows=num_trn_lines, dtype=int) - 1
val_ids = np.loadtxt('./data/DS/train_split', skiprows=num_trn_lines, dtype=int) - 1
