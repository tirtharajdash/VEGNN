...
#Takes one argument: one of {GNN, VEGNN, CEGNN, VECEGNN}
...
res1="Result_$1""1_HS1000_Czech"
res2="Result_$1""2_HS1000_Czech"
res3="Result_$1""3_HS1000_Czech"
res4="Result_$1""4_HS1000_Czech"
res5="Result_$1""5_HS1000_Czech"


#Result summary file:
resfile="./Results/$1""_HS1000.csv"
